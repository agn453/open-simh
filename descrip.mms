...
# HP C V7.3-009-48GBT (AXP), HP C V7.2-001 (IA64), v6.4-005(VAX); and
...
# Treat x86_64 with DEBUG the same as Alpha and IA64 but without networking for now 
.IFDEF MMSx86_64
ALPHA_OR_IA64 = 1
NONETWORK = 1
CC_FLAGS = /PREF=ALL/ACCEPT=(noVAXC_KEYWORDS)
...
# x86 without DEBUG has no networking for now
.IFDEF MMSx86_64
ALPHA_OR_IA64 = 1
NONETWORK = 1
CC_OPTIMIZE = /NOOPT
...
# PCAP is not available on OpenVMS VAX and not yet on OpenVMS x86
#
.IFDEF ALPHA_OR_IA64
.IFDEF NONETWORK
...
ALTAIRZ80M68K_DIR = SYS$DISK:[.ALTAIRZ80.M68K]
...
ALTAIRZ80_LIB3 = $(LIB_DIR)ALTAIRZ80L3-$(ARCH).OLB
ALTAIRZ80_SOURCE3 = $(ALTAIRZ80M68K_DIR)M68KASM.C,\
                    $(ALTAIRZ80M68K_DIR)M68KCPU.C,$(ALTAIRZ80M68K_DIR)M68KDASM.C,\
                    $(ALTAIRZ80M68K_DIR)M68KOPAC.C,$(ALTAIRZ80M68K_DIR)M68KOPDM.C,\
                    $(ALTAIRZ80M68K_DIR)M68KOPNZ.C,$(ALTAIRZ80M68K_DIR)M68KOPS.C,\
                    $(ALTAIRZ80_DIR)M68KSIM.C
ALTAIRZ80_OPTIONS = /INCL=($(SIMH_DIR),$(ALTAIRZ80_DIR),$(ALTAIRZ80M68K_DIR))/DEF=($(CC_DEFS))
...
$(ALTAIRZ80_LIB3) : $(ALTAIRZ80_SOURCE3)
        $!
        $! Building The $(ALTAIRZ80_LIB3) Library.
        $!
        $ $(CC)$(ALTAIRZ80_OPTIONS) -
               /OBJ=$(BLD_DIR) $(MMS$CHANGED_LIST)
        $ IF (F$SEARCH("$(MMS$TARGET)").EQS."") THEN -
...
$(BIN_DIR)ALTAIRZ80-$(ARCH).EXE : $(SIMH_MAIN) $(SIMH_NONET_LIB) $(ALTAIRZ80_LIB1) $(ALTAIRZ80_LIB2) $(ALTAIRZ80_LIB3)
        $!
        ...
        $ LINK $(LINK_DEBUG)/EXE=$(BIN_DIR)ALTAIRZ80-$(ARCH).EXE -
               ...
               $(ALTAIRZ80_LIB2)/LIBRARY,$(ALTAIRZ80_LIB3)/LIBRARY,$(SIMH_NONET_LIB)/LIBRARY
        $ DELETE/NOLOG/NOCONFIRM $(BLD_DIR)*.OBJ;*
